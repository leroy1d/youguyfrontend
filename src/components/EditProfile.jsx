...
const EditProfile = () => {
    ...
    return (
        <div className='flex max-w-2xl mx-auto pl-10 bg-white dark:bg-black min-h-screen'>
            <section className='flex flex-col gap-6 w-full my-8'>
                ...
                <div>
                    ...
                    <Textarea 
                        ...
                        name='bio' 
                        className="focus-visible:ring-transparent bg-white dark:bg-gray-800 text-black dark:text-white border-gray-300 dark:border-gray-600"
                    />
                </div>
                <div>
                    ...
                    <Select defaultValue={input.gender} onValueChange={selectChangeHandler}>
                        ...
                        <SelectContent className="bg-white dark:bg-gray-800 text-black dark:text-white border-gray-300 dark:border-gray-600">
                            <SelectGroup>
                                <SelectItem value="male" className="hover:bg-gray-100 dark:hover:bg-gray-700">Male</SelectItem>
                                <SelectItem value="female" className="hover:bg-gray-100 dark:hover:bg-gray-700">Female</SelectItem>
                            </SelectGroup>
                        </SelectContent>
                    </Select>
                </div>
