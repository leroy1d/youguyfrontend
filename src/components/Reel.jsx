...
const Reel = ({ reel }) => {
    ...
    const likeOrDislikeHandler = async () => {
        try {
            ...
            const res = await axios.get(`http://localhost:8001/api/v1/reel/${reel._id}/${action}`, { withCredentials: true });
            if (res.data.success) {
    ...
    const commentHandler = async () => {
        try {
            const res = await axios.post(`http://localhost:8001/api/v1/reel/${reel._id}/comment`, { text }, {
                headers: {
    ...
    const deleteReelHandler = async () => {
        try {
            const res = await axios.delete(`http://localhost:8001/api/v1/reel/delete/${reel?._id}`, { withCredentials: true })
            if (res.data.success) {
    ...
    const bookmarkHandler = async () => {
        try {
            const res = await axios.get(`http://localhost:8001/api/v1/reel/${reel?._id}/bookmark`, { withCredentials: true });
            if (res.data.success) {
                toast.success(res.data.message);
            }
        } catch (error) {
