...
const SuggestedProfiles = () => {
    ...
    useEffect(() => {
        const fetchSuggestedProfiles = async () => {
            try {
                setLoading(true)
                setError(null)
                const res = await axios.get(`https://youguybackend.vercel.app:8001/api/v1/user/suggested-profiles`, {
                ...
                try {
                    const fallbackRes = await axios.get(`https://youguybackend.vercel.app:8001/api/v1/user/suggested`, {
                        withCredentials: true
                    })
    ...
    const followUser = async (userId) => {
        try {
            const res = await axios.post(`https://youguybackend.vercel.app:8001/api/v1/user/followorunfollow/${userId}`, {}, {
                withCredentials: true
            })
